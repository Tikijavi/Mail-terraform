...
echo "127.0.0.1 mailserver.jdama.cf mailserver" | sudo tee -a /etc/hosts
#CREACION DE USUARIOS
sudo useradd -m user1
echo user1:maria | sudo chpasswd
sudo useradd -m user2
echo user2:maria | sudo chpasswd
#INSTALACIÓN APACHE
apt update -y
...
mysql -e "CREATE USER roundcube@localhost IDENTIFIED BY 'madame';"
...
wget https://raw.githubusercontent.com/mariaadame/m8/main/postfix-confma.sh
sh postfix-confma.sh
sudo apt update -y
...
wget https://raw.githubusercontent.com/mariaadame/m8/main/10-mail.conf
wget https://raw.githubusercontent.com/mariaadame/m8/main/10-auth.conf
...
wget https://raw.githubusercontent.com/mariaadame/m8/main/004-roundcube.conf
cp 004-roundcube.conf /etc/apache2/sites-available/004-roundcube.conf
a2dissite 000-default.conf
a2ensite 004-roundcube.conf
a2enmod rewrite
wget https://raw.githubusercontent.com/mariaadame/m8/main/defaults.inc.php
